...
import Html.Attributes exposing (class, width, height, id, src, alt, href)
...
view model =
        ...
        [
            ...
            span [ class "nav"] [
                a [ class (getSelected model Home), href "/home" ] [ text "HOME" ], 
                a [ class (getSelected model About), href "/about" ] [ text "ABOUT" ],
                a [ class (getSelected model Services), href "/services" ] [ text "SERVICES" ],
                a [ class (getSelected model Customers), href "customers" ] [ text "CUSTOMERS" ],
                a [ class (getSelected model Contact), href "contact" ] [ text "CONTACT" ]
            ],
            div [ class "content" ] [
                hr [] [],
                div [ class (getSelected model Home) ] [
                ...
                div [ class (getSelected model About) ] [
                    h1 [] [ text "About" ],
                ...
                div [ class (getSelected model Services) ] [ 
                    h1 [] [ text "Key Professional Qualifications and Skills" ],
                    ul [] [
                ...
                div [ class (getSelected model Customers) ] [ 
                    h1 [] [ text "Customers" ],
                    ...
                    ul [] [
                        ...
                        li [] [ p [] [ text "NTNU, Department of Computer and Information Science, Board Member and Advisory Board: 2002-2013" ] ]
                    ],
                    br [] [],
                ...
                div [ class (getSelected model Contact) ] [ 
                    ...
                    br [] [],
                    h2 [] [ text "Email" ],
                    p [] [ text "per.bakseter@pbconsulting.no" ],
                    br [] [],
                    h2 [] [ text "Mobile" ],
...
getSelected : Model -> Page -> String
getSelected model curPage  =
