...
import Html exposing (Html, img, text, div, p, h1, h2, h3, a, hr, ul, li, iframe, br, span)
...
--      , img [ id "solar", src "images/solcelle.jpg", alt "Solar" ] []
        ...
        , h3 [] [ a [ href "documents/CV_Per_Bakseter.doc" ] [ text "Download CV" ] ]
        ]
