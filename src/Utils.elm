...
blob id_ =
    div [ class "blob", id id_ ]
        [ Svg.svg [ Svg.Attributes.width "1200", Svg.Attributes.height "1200" ]
            [ Svg.defs []
                [ Svg.pattern
                    [ Svg.Attributes.id "img1"
                    , x "0"
                    , y "0"
                    , Svg.Attributes.width "1"
                    , Svg.Attributes.height "1"
                    , Svg.Attributes.viewBox "0 0 600 800"
                    , Svg.Attributes.preserveAspectRatio "xMidYMid slice"
                    ]
                    [ Svg.image [ Svg.Attributes.xlinkHref "/img/per1.jpg", Svg.Attributes.width "600", Svg.Attributes.height "800" ] [] ]
                ]
            , Svg.path
                [ Svg.Attributes.fill "url(#img1)"
